...
PythonHelp = f"⚡️ ​𝐃𝐀𝐍𝐈𝐄𝐋 𝗦𝗣𝗔𝗠 𝙃𝗘𝗟𝗣 𝙈𝗘𝗡𝗨 ⚡️\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @SHIVAM**"
...
async def help(event):
    if event.sender_id in SUDO_USERS:
       await event.client.send_file(event.chat_id,
                               "https://telegra.ph/file/88bbe9004d5660df05a27.jpg",
                                  caption=PythonHelp,
                                  buttons=[
           [
           ...
           [    
            Button.url("⚡️ ᴄʜᴀɴɴᴇʟ ⚡️", "https://t.me/DANIELDADDYi"),
            Button.url("⚡️ sᴜᴘᴘᴏʀᴛ ⚡️", "https://t.me/girlsboyschatting56")
           ],
           ],
           )
...
async def helpback(event):
   if event.query.user_id in SUDO_USERS:    
      await event.edit(
        ...
        await event.answer("𝗣ᴀʜʟᴇ 𝗝ᴀᴀᴋᴇ 𝗣ᴀᴘᴀ 𝗕ᴏʟ ⚡️𝐒𝐇𝐈𝐕𝐀𝗠⚡️ 𝗞ᴏ 𝗪ᴏ 𝗧ᴜᴍʜᴇ 𝗦ᴜᴅᴏ 𝗗ᴇ 𝗗ᴇɢᴀ", cache_time=0, alert=True)
