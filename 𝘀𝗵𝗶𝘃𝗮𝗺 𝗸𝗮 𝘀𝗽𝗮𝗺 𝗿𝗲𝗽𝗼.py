    ...
    if e.sender_id in SUDO_USERS:
        ...
        if len(altron) == 1:
            ...
            if int(e.chat_id) in GROUP:
                await e.reply("» ꜱᴏʀʀʏ, ᴛʜɪꜱ ɪ 𝐃𝐀𝐍𝐈𝐄𝐋 ᴘʀᴏᴛᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ.", parse_mode=None, link_preview=None )
            else:
...
async def hang(e):
    ...
    if e.sender_id in SUDO_USERS:
        ...
        if len(mkh) == 1:
            counter = int(mkh[0])
            if int(e.chat_id) in GROUP:
                await e.reply("» ꜱᴏʀʀʏ, ᴛʜɪꜱ ɪꜱ 𝐃𝐀𝐍𝐈𝐄𝐋 ᴘʀᴏᴛᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ.", parse_mode=None, link_preview=None)
            else:
