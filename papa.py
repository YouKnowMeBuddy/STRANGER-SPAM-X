...
PythonButton = [
        ...
        [
        Button.url("⚡️𝗖𝗛𝗔𝗡𝗡𝗘𝗟⚡️", "https://t.me/DANIELDADDYi"),
        Button.url("⚡️𝗦𝗨𝗣𝗣𝗢𝗥𝗧⚡️", "https://t.me/girlsboyschatting56")
        ],
        [
...
async def start(event):              
    if event.is_private:
        ...
        TEXT += f"» **✦ 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗗 𝗕𝗬 :~ [𝗦𝗛𝗜𝗩𝗔𝗠](https://t.me/Your_daddybro)**\n\n"
        TEXT += f"» **𝐃𝐀𝐍𝐈𝐄𝐋☫ 𝗦𝗣𝗔𝗠 𝗩𝗘𝗥𝗦𝗜𝗢𝗡 :** `3.2`\n"
